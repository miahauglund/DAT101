...
export function newGame() {
  ...
  GameProps.totalScore = 0; // Reset total score in GameProps
  GameProps.menu.updateTotalScore(0); // Reset the score in the menu
  GameProps.menu.showMenu(); // Update the menu
}
